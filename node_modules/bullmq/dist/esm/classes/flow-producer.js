...
export class FlowProducer extends EventEmitter {
    ...
    addNode({ multi, node, parent, queuesOpts }) {
        ...
        const job = new Job(queue, node.name, node.data, Object.assign(Object.assign(Object.assign({}, (jobsOpts ? jobsOpts : {})), node.opts), { parent: parent === null || parent === void 0 ? void 0 : parent.parentOpts }), jobId);
